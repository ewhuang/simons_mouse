...
to assign to all gene-GO edges. Output files network_no_go_1.txt, where 1
indicates we kept 1% of the graph. real_network_no_go_1.txt, network_go_1.txt,
and real_network_go_1.txt.
>>> python create_clustering_input.py
Output format for network_go.txt/network_no_go.txt:
0
NUM_NODES
gene_a  gene_b  edge_weight
gene_b  gene_a  edge_weight
Output format for real_network_no_go.txt/real_network_go.txt:
Real network
...
>>> ./sim_anneal/bin/cs-grn 20 1 0 ./data/orth.txt 1 ./data/network_go_1.txt -t 1 2> log > ./results/clusters_go_1.txt

Remove GO nodes from cluster files before evaluating.
>>> python post_cluster_remove_go.py
Creates ./results/clusters_go_clean_1.txt

Evaluate clusters.
>>> perl evaluate_clustering.pl ./results/clusters_no_go_1.txt ./data/real_network_no_go_1.txt

>>> perl evaluate_clustering.pl ./results/clusters_go_clean_1.txt ./data/real_network_go_1.txt
